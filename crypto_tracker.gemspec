...
require './lib/crypto_tracker/version'
...
Gem::Specification.new do |spec|
  ...
  spec.homepage = 'https://github.com/davide-almeida/crypto_tracker'
  spec.license = 'MIT'
  spec.required_ruby_version = '>= 3.1.0'

  spec.metadata['homepage_uri'] = spec.homepage
  spec.metadata['source_code_uri'] = 'https://github.com/davide-almeida/crypto_tracker'
  spec.metadata['changelog_uri'] = 'https://github.com/davide-almeida/crypto_tracker/releases'
